 ...
 */
@Data
public class AddStockPositionBatchItemParam {
     ...
     */
    private Integer stockPositionType = 0;

    /**
     * 库位摆放类型 1 平架区，2 平堆区，3 重力架区 4:高架区 默认0
     */
    private Integer stockPositionPutType = 0;
